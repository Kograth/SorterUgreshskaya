 ...
 * 2019-10-19T00:03:02.947+03:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "SorterExchange", 
                  wsdlLocation = "file:/C:/Work/tmp/JavaPrj/Netty_First_Step/src/main/resources/wsdl/SorterExchange.wsdl",
...
public class SorterExchange extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Work/tmp/JavaPrj/Netty_First_Step/src/main/resources/wsdl/SorterExchange.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SorterExchange.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Work/tmp/JavaPrj/Netty_First_Step/src/main/resources/wsdl/SorterExchange.wsdl");
        }
        WSDL_LOCATION = url;
    }
