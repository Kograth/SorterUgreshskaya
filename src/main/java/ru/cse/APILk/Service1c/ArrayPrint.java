...
/**
 * <p>Java class for ArrayPrint complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ArrayPrint"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}PrintDocuments" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ArrayPrint", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ArrayPrint {
    ...
    protected List<PrintDocuments> items;
     ...
     * 
     */
    public List<PrintDocuments> getItems() {
        if (items == null) {
            items = new ArrayList<PrintDocuments>();
        }
        return this.items;
    }
