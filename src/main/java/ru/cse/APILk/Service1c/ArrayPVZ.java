...
/**
 * <p>Java class for ArrayPVZ complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ArrayPVZ"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}PVZ" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ArrayPVZ", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ArrayPVZ {

    @XmlElement(name = "Items", nillable = true)
    protected List<PVZ> items;
     ...
     * 
     */
    public List<PVZ> getItems() {
        if (items == null) {
            items = new ArrayList<PVZ>();
        }
        return this.items;
    }
