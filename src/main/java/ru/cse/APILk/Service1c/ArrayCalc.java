...
/**
 * <p>Java class for ArrayCalc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ArrayCalc"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}Calc" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ArrayCalc", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ArrayCalc {
     ...
     * 
     */
    public List<Calc> getItems() {
        if (items == null) {
            items = new ArrayList<Calc>();
        }
        return this.items;
    }
