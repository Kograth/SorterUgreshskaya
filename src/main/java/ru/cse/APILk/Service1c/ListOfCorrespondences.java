...
/**
 * <p>Java class for ListOfCorrespondences complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfCorrespondences"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}Correspondence" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ListOfCorrespondences", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ListOfCorrespondences {

    @XmlElement(name = "Items", nillable = true)
    protected List<Correspondence> items;
     ...
     * 
     */
    public List<Correspondence> getItems() {
        if (items == null) {
            items = new ArrayList<Correspondence>();
        }
        return this.items;
    }
