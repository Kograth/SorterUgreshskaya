...
/**
 * <p>Java class for ResultTracking complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ResultTracking"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}TrackingInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ResultTracking", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ResultTracking {
    ...
    protected List<TrackingInfo> items;
     ...
     * 
     */
    public List<TrackingInfo> getItems() {
        if (items == null) {
            items = new ArrayList<TrackingInfo>();
        }
        return this.items;
    }
