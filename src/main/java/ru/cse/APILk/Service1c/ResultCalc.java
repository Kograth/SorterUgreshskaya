...
/**
 * <p>Java class for ResultCalc complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ResultCalc"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Results" type="{http://www.cse-cargo.ru/client}Costings" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ResultCalc", propOrder = {
    "error",
    "errorInfo",
    "results"
})
public class ResultCalc {
    ...
    protected List<Costings> results;
     ...
     * 
     */
    public List<Costings> getResults() {
        if (results == null) {
            results = new ArrayList<Costings>();
        }
        return this.results;
    }
