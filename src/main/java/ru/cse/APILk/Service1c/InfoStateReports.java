...
/**
 * <p>Java class for InfoStateReports complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InfoStateReports"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "InfoStateReports", propOrder = {
    "date",
    "code",
    "codeDescription"
})
public class InfoStateReports {
    ...
    @XmlElementRef(name = "CodeDescription", namespace = "http://www.cse-cargo.ru/client", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codeDescription;
     ...
     *     
     */
    public JAXBElement<String> getCodeDescription() {
     ...
     *     
     */
    public void setCodeDescription(JAXBElement<String> value) {
