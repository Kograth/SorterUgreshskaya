...
/**
 * <p>Java class for ArrayCostings complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ArrayCostings"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Items" type="{http://www.cse-cargo.ru/client}Costings" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ArrayCostings", propOrder = {
    "items",
    "error",
    "errorInfo"
})
public class ArrayCostings {

    @XmlElement(name = "Items", nillable = true)
    protected List<Costings> items;
     ...
     * 
     */
    public List<Costings> getItems() {
        if (items == null) {
            items = new ArrayList<Costings>();
        }
        return this.items;
    }
