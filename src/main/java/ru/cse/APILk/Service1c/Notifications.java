...
public class Notifications {
    ...
    @XmlElementRef(name = "SMS", namespace = "http://www.cse-cargo.ru/client", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> sms;
    @XmlElementRef(name = "Email", namespace = "http://www.cse-cargo.ru/client", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> email;
     ...
     *     
     */
    public JAXBElement<Boolean> getSMS() {
        return sms;
    }
     ...
     *     
     */
    public void setSMS(JAXBElement<Boolean> value) {
        this.sms = value;
    }
     ...
     *     
     */
    public JAXBElement<Boolean> getEmail() {
        return email;
    }
     ...
     *     
     */
    public void setEmail(JAXBElement<Boolean> value) {
        this.email = value;
    }
