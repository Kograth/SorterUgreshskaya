...
public class MeasurerCargo extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://sp1/cse82_reg/ws/MeasurerCargo?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MeasurerCargo.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://sp1/cse82_reg/ws/MeasurerCargo?wsdl");
        }
        WSDL_LOCATION = url;
    }
